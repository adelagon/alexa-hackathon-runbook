...
This is a sample template for alexa-random-fact - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name alexa-random-fact --query 'Stacks[].Outputs'
```
