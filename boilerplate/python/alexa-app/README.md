...
This is a sample template for alexa-app - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name alexa-app --query 'Stacks[].Outputs'
```
